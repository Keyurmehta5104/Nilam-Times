...
export const useInvoices = () => {
    ...
    try {
      ...
      for (const docSnap of querySnapshot.docs) {
        ...
        invoicesData.push({
          ...
          customer_state: invoiceData.customer_state || null,
          customer_code: invoiceData.customer_code || null,
  ...
  const updateInvoice = async (
    ...
    try {
      ...
      if (invoiceData.customer_address !== undefined) updateData.customer_address = invoiceData.customer_address;
      if (invoiceData.customer_gstin !== undefined) updateData.customer_gstin = invoiceData.customer_gstin;
      if (invoiceData.customer_state !== undefined) updateData.customer_state = invoiceData.customer_state;
      if (invoiceData.customer_code !== undefined) updateData.customer_code = invoiceData.customer_code;
