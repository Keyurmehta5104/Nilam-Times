      ...
      <div className="max-w-7xl mx-auto py-4 sm:py-8 px-3 sm:px-4 mb-20 lg:mb-0">
            ...
            <CardContent className="pt-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-2xl sm:text-3xl font-bold">{totals.clients}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-2xl sm:text-3xl font-bold">{totals.invoices}</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4 sm:space-y-6">
          <TabsList className="grid w-full grid-cols-3 h-auto">
            <TabsTrigger value="overview" className="text-xs sm:text-sm">Client-wise</TabsTrigger>
                          ...
                          <CardContent className="p-4">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                              <div className="bg-muted p-3 rounded">
                                ...
                                <p className="text-lg font-bold">{client.totalInvoices}</p>
                              </div>
